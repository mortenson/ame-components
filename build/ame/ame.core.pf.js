...
var s=document.querySelector("script[data-core='ame.core.js'][data-path]");if(s){publicPath=s.getAttribute('data-path');}
(function (window, document, Context, appNamespace, publicPath) {
    ...
    function h(nodeName, vnodeData, child) {
        ...
        if (vnode.vattrs) {
            ...
            if (vnode.vattrs.class && typeof vnode.vattrs.class === 'string') {
                var classList = vnode.vattrs.class.trim().split(/\s+/);
                vnode.vattrs.class = {};
                for (var _i = classList.length - 1; _i > -1; _i -= 1) {
                    vnode.vattrs.class[classList[_i]] = true;
                }
            }
        }
        return vnode;
    ...
    function setAccessor(plt, elm, name, oldValue, newValue, isSvg) {
        ...
        if (name === 'class' && !isSvg) {
            newValue = newValue || {};
            oldValue = oldValue || {};
            var newClassNameString = '';
            var oldClassNameString = '';
            for (key in oldValue) {
