...
var AmeEdit = /** @class */ (function () {
    ...
    AmeEdit.prototype.render = function () {
        return (h("button", null, this.enabled ? 'Disable editing' : 'Enable editing'));
    };
    return AmeEdit;
}());
...
var AmeHandler = /** @class */ (function () {
    ...
    AmeHandler.prototype.save = function () {
        var _this = this;
        this.getChangedResources().then(function (resources) {
            for (var key in resources) {
                _this.lastResources[key] = resources[key];
            }
            _this.saveComplete.emit(resources);
        });
    };
    AmeHandler.prototype.componentDidLoad = function () {
        var _this = this;
        this.getResources().then(function (resources) {
            _this.lastResources = resources;
        });
    };
    AmeHandler.prototype.sortObject = function (object) {
        var sorted = {};
    ...
    AmeHandler.prototype.objectsMatch = function (object1, object2) {
        return JSON.stringify(this.sortObject(object1)) == JSON.stringify(this.sortObject(object2));
    };
    AmeHandler.prototype.getChangedResources = function () {
        var _this = this;
        return this.getResources().then(function (resources) {
            var changed = {};
            for (var key in resources) {
                if (!(key in _this.lastResources) || !_this.objectsMatch(resources[key], _this.lastResources[key])) {
    ...
    AmeHandler.prototype.getElementValue = function (element) {
        if ('value' in element) {
    ...
    AmeHandler.prototype.elementIsReady = function (element) {
        if ('componentOnReady' in element) {
            return element.componentOnReady().then(function (component) {
                return component;
            });
        }
        return Promise.resolve(element);
    };
    AmeHandler.prototype.getResources = function () {
        var _this = this;
        if (!this.handlerName) {
            return Promise.resolve({});
        }
        var resources = {}, promises = [];
        ...
        var _loop_1 = function (i) {
            ...
            var promise = this_1.elementIsReady(elements[i]);
            promise.then(function (element) {
                _this.setPathValue(resources[key], path.split('.'), _this.getElementValue(element));
            });
...
var AmeRestHandler = /** @class */ (function (_super) {
    __extends(AmeRestHandler, _super);
    function AmeRestHandler() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    AmeRestHandler.prototype.getUrl = function (path) {
        return this.baseUrl.replace(/\/+$/, '') + '/' + path.replace(/^\/+/, '');
    };
    AmeRestHandler.prototype.save = function () {
        var _this = this;
        if (this.baseUrl) {
            this.getChangedResources().then(function (resources) {
                var _loop_1 = function (key) {
                    ...
                    tokenRequest.open('GET', _this.getUrl('/rest/session/token'));
                    tokenRequest.addEventListener('load', function () {
                        if (tokenRequest.status === 200) {
                            var patchRequest_1 = new XMLHttpRequest();
                            patchRequest_1.open('PATCH', _this.getUrl(key));
                            patchRequest_1.setRequestHeader('X-CSRF-Token', tokenRequest.responseText);
                            patchRequest_1.setRequestHeader('Content-Type', 'application/json');
                            patchRequest_1.setRequestHeader('Accept', 'application/json');
                            patchRequest_1.addEventListener('load', function () {
                                console.log(patchRequest_1);
                            });
                            patchRequest_1.send(JSON.stringify(resources[key]));
                            _this.saveComplete.emit(resources);
                        }
                    });
                    tokenRequest.send();
    ...
    AmeRestHandler.prototype.render = function () {
        return (h("span", null));
    };
    return AmeRestHandler;
}(AmeHandler));
...
var AmeText = /** @class */ (function () {
    ...
    AmeText.prototype.render = function () {
        return (h("span", { contenteditable: this.editable ? 'true' : 'false', onClick: this.handleClick.bind(this), onBlur: this.handleBlur.bind(this), onKeyDown: this.handleKeyDown.bind(this) },
            h("slot", null)));
    };
    return AmeText;
}());

var AmeValue = /** @class */ (function () {
    function AmeValue() {
    }
    AmeValue.prototype.value = function () {
        return this.return;
    };
    AmeValue.prototype.render = function () {
        return (h("span", null));
    };
    return AmeValue;
}());
...
exports['AME-REST-HANDLER'] = AmeRestHandler;
exports['AME-RICH-TEXT'] = AmeRichText;
exports['AME-SAVE'] = AmeSave;
exports['AME-TEXT'] = AmeText;
exports['AME-VALUE'] = AmeValue;
},
...
/***************** ame-rest-handler *****************/
[
/** ame-rest-handler: tag **/
"AME-REST-HANDLER",

/** ame-rest-handler: members **/
[
  [ "baseUrl", /** prop **/ 1 ],
  [ "handlerName", /** prop **/ 1 ],
  [ "save", /** method **/ 6 ]
...
/** ame-rest-handler: host **/
{},

/** ame-rest-handler: events **/
[
  [
    /*****  ame-rest-handler saveComplete ***** /
    /* event name ***/ "saveComplete"
  ]
]
...
/** ame-rich-text: events **/
0 /* no events */,

/** ame-rich-text: propWillChanges **/
[
  [
    /*****  ame-rich-text prop will change [0] ***** /
    /* prop name **/ "editable",
    /* call fn *****/ "handleEditableChange"
  ]
]
